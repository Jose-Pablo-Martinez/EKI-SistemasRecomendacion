window.pages.home = () => {
    renderPage(`
        <div class="flex-1 flex flex-col items-center justify-center p-8 py-12 md:py-24 2xl:py-32 text-center eki-texture-bg relative w-full">
            ...
            <a href="#/registro" class="bg-accent text-white px-8 py-3 2xl:px-12 2xl:py-4 2xl:text-xl rounded-md font-semibold text-label-lg hover:bg-accent-hover transition-colors shadow relative z-10">Empezar ahora</a>
        </div>
    `);
};
